...
//Left Motors:
motor_group(LeftFront, LeftBack, LeftMiddle),

//Right Motors:
motor_group(RightFront, RightBack, RightMiddle),
...
void usercontrol(void) {
  ...
  while (1) {
    ...
    IntakeTop.setVelocity(80, percent);
    //Intake control
    ...
    if(controller(primary).ButtonL1.pressing())
    {
      ...
      //if R2 is pressed it turns on the Bottom Intake

    }
    else if(controller(primary).ButtonL2.pressing())
    { //if R1 is pressed it turns on the Top Intake
      IntakeTop.spin(reverse);
      IntakeBottom.spin(reverse);

    }
    else if(controller(primary).ButtonR1.pressing())
    { //if L2 is pressed it holds the balls in
      IntakeBottom.spin(forward);
    ...
    else if(controller(primary).ButtonY.pressing())
    {
      descore.set(false);
    }
